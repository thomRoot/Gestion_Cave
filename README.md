...
- ✅ Barre de maturation du vin affichée sous chaque image dans les résultats
- ✅ Période de consommation affichée pour chaque bouteille
- ✅ Le texte de recherche est effacé à chaque changement de mode (IA/Cave)

**Améliorations :**
- Meilleure expérience utilisateur pour la recherche
